                ...
                <div class="col-md-12">
                    ...
                    <div class="costum-table table-responsive">
                        <table id="dataTableMaster" class="table table-borderless table-data1 text-center align-center table-color-bg costum-rounded" style="font-size: 10pt;">
                            ...
                            <tbody>
                            <?php foreach($vendor as $key => $ven) : ?>
                                <tr>
                                    <td><?= $key+1 ?></td>
                                    <td><?= $ven['NAMA_VENDOR'] ?></td>
                                    <td>
                                        <a href="<?= base_url('/edit_vendormaster_op/'.$ven['ID_VENDOR']) ?>" class="btn btn-secondary btn-sm rounded-circle" title="Edit">
                                             <i class="zmdi zmdi-edit"></i>
                                        </a>
                                        <!-- <a href="<?= base_url('/hapus_vendormaster_op/'.$ven['ID_VENDOR']) ?>" class="delete btn btn-danger btn-sm rounded-circle" title="Hapus">
