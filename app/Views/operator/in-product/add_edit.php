                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3">
                                        <div class="form-group mb-3">
                                            ...
                                            <?php if ($formHeader=="Tambah Barang Masuk") : ?>
                                                <input type="text" class="form-control w-100 costum-rounded" id="DATE_IN" name="DATE_IN" value="<?= $tanggal_masuk; ?>" readonly>
                                            <?php else: ?>
                                                <input type="text" class="form-control w-100 costum-rounded" id="DATE_IN" name="DATE_IN" value="<?= $transac['DATE_IN']; ?>" readonly>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-md-2">
                                        <div class="form-group mb-3">
                                            ...
                                            <?php else: ?>
                                            <select name="ID_BARANG" id="ID_BARANG" class="js-select2-extend form-control" onchange="getDetailProduk()" <?php if ($formHeader=="Edit Barang Masuk") {echo 'readonly'; } ?>>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-md-2">
                                        <div class="form-group mb-3">
                                            ...
                                            <?php if ($formHeader=="Tambah Barang Masuk") : ?>
                                                <input type="number" min="0" name="STOK_MASUK" id="STOK_MASUK" class="form-control w-100 costum-rounded" value="<?= (isset($transac['JUMLAH_BARANG'])) ? $transac['JUMLAH_BARANG'] : ''; ?>">
                                            <?php else: ?>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="VENDOR" id="VENDOR" class="js-select2-extend form-control">
                                                ...
                                                <?php if (isset($transac['ID_VENDOR']) && $itemvendor['ID_VENDOR']==$transac['ID_VENDOR']) : ?>
                                                        <option value="<?= $itemvendor['ID_VENDOR']; ?>" selected><?= $itemvendor['NAMA_VENDOR']; ?></option>
                                                <?php else: ?>
                                                    <option value="<?= $itemvendor['ID_VENDOR']; ?>"><?= $itemvendor['NAMA_VENDOR']; ?></option>
                                                <?php endif;?>
                                                <?php endforeach;?>
                                            </select>
                                        </div>
